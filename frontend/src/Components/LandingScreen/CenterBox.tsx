      ...
      <div className="right-side">
        {
          ...
          <>
            ...
            <p className='p-content'>
              ...
              is your inviting haven. With seamless messaging, expressive emojis, 
              and a warm atmosphere, ChatNest is more than an app; it's your 
              digital home for connecting, sharing, and creating lasting memories. 
              Join the nest, spread your wings, and let the conversations soar! 🚀🐦
            </p>
          </>
        }
      </div>
